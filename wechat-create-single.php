...
$menuName = 'we-entry';
$submenuName = 'we-chat-create-single';
...
if (isset($_REQUEST['SubmitEntry'])) {
    ...
    if ($ubal > 0) {
        ...
        if($flag == 1){
            mysql_query("insert into wechat_orders (`msgdate`,`msgtime`,sender_id,`msg`,`msglogo`,`msgimage`,`msgvideo`,`mobilenumber`,`uid`) values('" . $_REQUEST['msgdate'] . "','" . $msgtime. "','".$_REQUEST['sender_id']."','" . $_REQUEST['msg'] . "','" . $newfilename_logo . "','" . $newfilename . "','" . $newfilename_video . "','" . $_REQUEST['numberfile'] . "','" . $_SESSION['ADMINID'] . "')");

            $_SESSION['SUCCESS'] = "Your Order Saved Successfully";
            //header('location:entry-create.php');
            echo '<script>window.location="wechat-create-single.php"</script>';
            exit;
        }
                        ...
                        <div class="col-lg-8">
                            <div class="ibox float-e-margins box-info">
                                <div class="ibox-title" style="height: 75px;">
                                    <h3 class="box-title" >Send Wechat Message </h3><h4>(Text=1 Credit/Image=1 Credits/Text + Image = 2 credits/Video = 2 credits)</h4>
                                </div>
                                <div class="ibox-content">
                                    ...
                                    <form method="post" class="form-horizontal info" enctype="multipart/form-data" id="uploadForm">
...
<!--                                                    <label>you exceed your per day limit of sending whatsapp msf</label>-->
                        ...
                        <div class="col-lg-4">
                            ...
                            <div style="padding-top: 5px;background: url(img/whatsapp_img2.png);background-size: 100% 100%;height: 450px;background-repeat: no-repeat;">
...
function readURL(input)
            ...
            function text_caption(){
                ...
                jQuery("#disp_caption").html('<p style="padding-left: 10px;padding-top: 10px;padding-bottom: 5px;width: 90%;word-wrap: break-word;">'+imagecap+'</p>');
