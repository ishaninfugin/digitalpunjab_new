...
ob_start();
	...
	$menuName = 'belt';
	$submenuName = 'belt-create';
	
	if(isset($_REQUEST['CreateBelt'])) {
		$title = $_REQUEST['title'];
		$content = mysql_real_escape_string(trim(strtolower($_REQUEST['content'])));
		AddBelt($title, $content);		
	}
...
?>
                ...
                <form method="post" class="form-horizontal info">
                    <div class="form-group"><label class="col-sm-2 control-label">Name</label>
                        <div class="col-sm-10">
                        <input type="text" name="title" class="form-control validate[required,custom[onlyLetterSp]]">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-4 col-sm-offset-2">
                            <button class="btn btn-primary" name="CreateBelt" type="submit">Create Belt</button>
                        </div>
                    </div>
                </form>
            </div>
