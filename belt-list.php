...
ob_start();
	...
	if(isset($_REQUEST['editId'])) {
		...
		echo "<script> window.location.href = 'belt-edit.php?id=".$editId."'; </script>";
		exit();
	}
	
	$BeltList = GetMultiRows(BELT);
...
<table class="table table-striped table-bordered table-hover " id="editable" >
            ...
            <?php
				$sr=1;
				foreach($BeltList as $BeltDetail) {
					?>
                    <tr class="gradeX" id="list_<?php echo $BeltDetail['id']; ?>">
                        <td><?php echo $sr++; ?></td>
                        <td><?php echo $BeltDetail['title']; ?></td>
                        <td><?php echo substr($BeltDetail['content'],0,100); ?></td>
                        <td class="center">
                        <a href="belt-list.php?editId=<?php echo $BeltDetail['id']; ?>" class="btn btn-success btn-xs">Edit</a>
                        <a onClick="DeleteRecord('<?php echo BELT; ?>', <?php echo $BeltDetail['id']; ?>)" class="btn btn-danger btn-xs">Delete</a>
                        </td>
                    </tr>
                    <?php
				}
