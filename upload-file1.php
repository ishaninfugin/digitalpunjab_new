...
if ($_FILES['msg']["name"] != '') {
    ...
    $newfilename3 = "uploads/" . "msg" . $created . $nextid . "." . $ext;
    //echo $created;
    //echo $newfilename3;exit;
    move_uploaded_file($fileTmpLoc, "uploads/" . "msg" . $created . $nextid . "." . $ext);
}

//$FileName=$created.'_'.$newfilename3;
//echo "<pre>";Print_r($_FILES).'  __'.$newfilename3;exit;

mysql_query("update orders set confirmedlist='" . $newfilename3 . "' where id=" . $_REQUEST['orderid']);
