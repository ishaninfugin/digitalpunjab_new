...
ob_start();
	...
	if(isset($_REQUEST['editId'])) {
		...
		echo "<script> window.location.href = 'scheme-edit.php?id=".$editId."'; </script>";
		exit();
	}
	
	$SchemeList = GetMultiRows(SCHEME);
...
<table class="table table-striped table-bordered table-hover " id="editable" >
            ...
            <?php
				$sr=1;
				foreach($SchemeList as $SchemeDetail) {
					?>
                    <tr class="gradeX" id="list_<?php echo $SchemeDetail['id']; ?>">
                        <td><?php echo $sr++; ?></td>
                        <td><?php echo $SchemeDetail['details']; ?></td>
                        <td><?php echo DayMonthYear($SchemeDetail['start_date']); ?></td>
                        <td><?php echo DayMonthYear($SchemeDetail['end_date']); ?></td>
                        <td class="center">
                        <a href="scheme-list.php?editId=<?php echo $SchemeDetail['id']; ?>" class="btn btn-success btn-xs">Edit</a>
                        <a onClick="DeleteRecord('<?php echo SCHEME; ?>', <?php echo $SchemeDetail['id']; ?>)" class="btn btn-danger btn-xs">Delete</a>
                        </td>
                    </tr>
                    <?php
				}
