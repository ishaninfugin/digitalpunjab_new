...
$PageTitle = 'Manager Staff List';
$menuName = 'user';
$submenuName = 'manager-staff-list';
...
$condition = "actype='S' and (addedby=0 or addedby=1)";
...
if($_SESSION['ACTYPE'] == 'A')
{
	...
	{
		$_SESSION['page'] = 'manager-staff-list.php';
                ...
                <div class="col-lg-12">
                       <div class="widget flat radius-bordered">
							...
							<div class="dt-buttons">								
								<a class="dt-button btn " tabindex="0" aria-controls="editable" href="export_user.php?uid=admin"><span>Export to Excel</span></a>
							</div>
                            <br>
                            <div id="errormsg"> </div>
                                    ...
                                    <tr class="gradeX" id="list_<?php echo $USerDetail['id']; ?>">
                                        ...
                                        <td class="center">
                                            ...
                                            <?php }
                                                ...
                                                <a href="javascript:void(0);" data_id="manager-staff-list.php?upassId=<?php echo $USerDetail['id']; ?>" class="btn btn-success btn-xs update_pass"><i class="fa fa-book"></i> Update Password</a>
...
if (tblname == 'tbl_admin') {
            $.ajax({
                type: "GET",
                url: "delete-employee-number.php?id="+id,
                cache: false,
    ...
    jQuery(document).on('submit','#add_admin_password_form_delete',function(e){
        ...
        jQuery.ajax({
            ...
            success: function(data) {
                var obj = jQuery.parseJSON(data);
                if(obj.status == 1){
console.log(jQuery('#hidden_table_name').val());
console.log(jQuery('#hidden_delete_id').val());
